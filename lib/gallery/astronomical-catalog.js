...
const catalog = {
  ...
  'Orion Nebula': {
    ...
    descriptions: {
      excellent: 'The Great Orion Nebula was a showpiece — under Atacama\'s Bortle 1 skies, the nebula\'s vast wings of glowing gas extended far beyond the bright Trapezium cluster at its heart. Delicate wisps and dark rifts carved through the nebulosity, with the faintest outer regions visible to the naked eye. At 1,344 light-years away, this is the closest massive star-forming region to Earth — a stellar nursery where new solar systems are being born right now.',
      good: 'The Great Nebula was magnificent — the four young Trapezium stars blazed at the core while wings of luminous gas fanned out in all directions. Dark lanes and bright ridges gave the nebula a dramatic three-dimensional quality.',
      standard: 'Visible to the naked eye below Orion\'s belt, the Orion Nebula revealed its true nature through the telescope — a vast cloud of glowing gas and dust where hundreds of new stars are forming. The four Trapezium stars at its core were clearly resolved.'
    }
  },
  'Carina Nebula': {
  ...
  'Jupiter': {
    ...
    ra: 'varies', dec: 'varies',
    descriptions: {
      excellent: 'Jupiter was stunning through the telescope — the cloud bands were sharply defined across the planet\'s disk, with subtle color variations between the darker belts and brighter zones. The four Galilean moons — Io, Europa, Ganymede, and Callisto — were visible as bright points flanking the giant planet like a miniature solar system.',
      good: 'The gas giant revealed its characteristic equatorial cloud bands as dark stripes across the bright disk, with the Galilean moons visible as pinpoints of light alongside the planet.',
      standard: 'Jupiter showed its main cloud bands through the telescope, with its four largest moons — discovered by Galileo in 1610 — visible as bright dots arranged around the planet.'
    }
  },
  'Saturn': {
    catalog: 'Planet', type: 'planet',
  ...
  'Flame Nebula': {
    ...
    constellation: 'Orion', distance: '1,350 ly', magnitude: '10.0',
    ra: '05h 42m', dec: '-01° 51\'',
    descriptions: {
      excellent: 'The Flame Nebula burned brightly next to Alnitak, the easternmost star of Orion\'s belt — intricate dark lanes threaded through the glowing gas like veins of shadow, creating the unmistakable flame shape. This challenging visual target is a neighbor of the Orion Nebula in the same vast molecular cloud complex.',
      good: 'Adjacent to bright Alnitak, the Flame Nebula revealed its characteristic pattern of dark dust lanes carving through the emission nebulosity, giving it its fiery appearance.',
      standard: 'The Flame Nebula was observed near Orion\'s belt star Alnitak — a challenging target where dark lanes of interstellar dust create the illusion of flames licking through glowing gas.'
    }
  },
  'Horsehead Nebula': {
