...
// ============ CONFIGURATION ============
const PRODUCTS = {
  // Tour Regular (grupo compartido) - Time Period format (GYG portal config)
  '1152147': {
    productId: '1152147',
    ...
    availableTimes: ['21:00'], // used internally for booking time extraction
  ...
  // Tour Semi-Privado (precio por persona, max 4) - Time Period format (GYG portal config)
  '1163787': {
    productId: '1163787',
